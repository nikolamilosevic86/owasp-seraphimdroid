...
public class Share {
    ...
    private static Uri getUriForFile(Context context, File file) {
        return FileProvider.getUriForFile(context, "org.owasp.seraphimdroid" + ".fileprovider", file);
    }
    ...
    public static void addFileToShareIntent(Context context, Intent intent, String filename) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            ...
            for (ResolveInfo resolveInfo : resInfoList) {
                ...
                // Junfan https://stackoverflow.com/questions/24467696/android-file-provider-permission-denial add something here
