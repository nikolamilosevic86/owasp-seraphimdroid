...
public class SMSReciever extends BroadcastReceiver {
	...
	private void showNotification(Context context, CharSequence title,
			CharSequence text) {
	...
	public void onReceive(Context context, Intent intent) {
		// this regex matches all url.. All google.com, http://google.com ,
		// www.google.com and http://www.google.com will be matched
		...
		if (intent.getAction().equals(SMS_RECEIVED_ACTION)) {
			...
			// TODO: Add various regex for phishing (phone number, url without
			// http)
			if (IsMatch(smsData, regex)) {
				showNotification(context,
						"Souspicious SMS (Potencial phishing)", smsData);
